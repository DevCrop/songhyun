...
// $feces_time   = $_POST['feces_time'] ?? null; // 삭제
$feces_days     = $_POST['feces_days'] ?? null;
$feces_count    = $_POST['feces_count'] ?? null;
// $urine_time   = $_POST['urine_time'] ?? null; // 삭제
...
try {
    ...
    $query = "
        INSERT INTO nb_herb_inquiries (
            ...
            treatment, symptoms, drink, 
            feces_days, feces_count,
            urine_days, urine_count,
    ...
    // $stmt->bindParam(':feces_time', $feces_time); // 삭제
    $stmt->bindParam(':feces_days', $feces_days, PDO::PARAM_INT);
    $stmt->bindParam(':feces_count', $feces_count, PDO::PARAM_INT);
    // $stmt->bindParam(':urine_time', $urine_time); // 삭제
    $stmt->bindParam(':urine_days', $urine_days, PDO::PARAM_INT);
    $stmt->bindParam(':urine_count', $urine_count, PDO::PARAM_INT);
