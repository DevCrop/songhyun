                    ...
                    <div class="no-card">
                        ...
                        <div class="no-card-body no-admin-column no-admin-column--detail">
							...
							<div class="no-admin-block">
								...
								<div class="no-admin-content">
									<input type="text"
										value="대변: <?= htmlspecialchars($data['feces_days']) ?>일에 <?= htmlspecialchars($data['feces_count']) ?>번 / 소변: <?= htmlspecialchars($data['urine_days']) ?>일에 <?= htmlspecialchars($data['urine_count']) ?>번"
										readonly>
								</div>
							</div>
