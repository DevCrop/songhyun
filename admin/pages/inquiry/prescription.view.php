                    ...
                    <div class="no-toolbar-container">
                        <div class="no-card">
                            ...
                            <div class="no-card-body no-admin-column no-admin-column--detail">
								...
								<?php if (!empty($data['feces_days']) || !empty($data['feces_count'])): ?>
								<div class="no-admin-block">
									<h3 class="no-admin-title">대변 주기</h3>
									<div class="no-admin-content">
										<input type="text"
											value="<?= htmlspecialchars($data['feces_days']) ?>일에 <?= htmlspecialchars($data['feces_count']) ?>번"
											readonly>
									</div>
								</div>
								<?php endif; ?>

								<?php if (!empty($data['urine_days']) || !empty($data['urine_count'])): ?>
								<div class="no-admin-block">
									<h3 class="no-admin-title">소변 주기</h3>
									<div class="no-admin-content">
										<input type="text"
											value="<?= htmlspecialchars($data['urine_days']) ?>일에 <?= htmlspecialchars($data['urine_count']) ?>번"
											readonly>
									</div>
								</div>
								<?php endif; ?>
