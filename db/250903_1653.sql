...
(23, 'SIXDOT', 'Lacimbali', 'pro', '2025-09-03 07:46:08', '', NULL, 'Y', 'N', 0, 20, 0, 'N', 0, 'N', NULL, NULL, NULL, NULL, 'Y', '전기 모델 1 ', '전기 모델 2', '전력 모델 1', '전력 모델 2', '사이즈 모델 1', '사이즈 모델 2', '스팀보일러 모델 1', '스팀보일러 모델 2', '커피보일러 모델 1', '커피보일러 모델 2', '메뉴 모델 1', '메뉴 모델 2', '추출양 모델 1', '추출양 모델 2', 'HOT WATER WAND 모델 1', 'HOT WATER WAND 모델 2', 'TURBO STEAM 모델 1', 'TURBO STEAM 모델 2', 'MILK 모델 1', 'MILK 모델 2', 'GRINDER/HOPER 모델 1', 'GRINDER/HOPER 모델 2 ', 'HOPER CAP 모델 1', 'HOPER CAP 모델 2', '', '', '', '', '', '', 'Y', 'init');
